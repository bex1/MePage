...
<div id="content">
	...
	<article class="justify borderRight width80">
		...
		<p>Jag sitter på Windows 8.1 och använder normalt Google Chrome som webbläsare.</p>
		...
		<p>Bortsett från att ha pillat lite med HTML och CSS i mina
            ...
            mer oförutsägbar och långsam.</p>
		...
		<p> Guiderna var vettiga och lätta att förstå. Jag skulle dock vilja se att man kunde lyfta fram i vilken ordning
            ...
            används i ganska stor utsträckning idag, eller varför inte lära sig lite dreamweaver, men det kanske kommer senare.</p>
		...
		<p>Strukturen av filer och kataloger känns bra vid sidans nuvarande storlek. Dock så borde sidorna också kategoriseras
            om sidan växer, vilket man kanske borde förbereda direkt så man slipper ändra filreferenser i massa filer.</p>
        <h4>Övrigt</h4>
        ...
        <p> Det blev väl en hel del copy-paste av mos kod, så jag stötte knappt då några problem eller svårigheter.
            ...
            lösningarna var sådär. Det skulle vara intressant att få lite mer säkerhetskunskap om sessioner i php.</p>
        ...
        <p> Inom php så måste jag säga att jag är nybörjare då jag inte känner till biblioteket tillräckligt för att kalla mig något
            annat. Dock så är jag erfaren inom programmering så tänket är inga problem.</p>
        ...
        <p> Jag känner inte direkt igen mig då jag inte nyttjat phps bibliotek speciellt mycket förut. Dock så är syntaxen inga problem,
            ...
            funktionernas funktionalitet. Det är få språk som har sådan tydlig dokumentation, vilket är en stor fördel.</p>
        ...
        <p> Jag är kunnig inom språk som java, c++, c, c#, python, SQL, ruby on rails, Objective-C, perl osv,
            och jobbar även deltid som konsult som programmerare.</p>
        ...
        <p> Att php är löst typat har sina fördelar och sina nackdelar. En av fördelarna är väl att det är lätt att lära sig
            ...
            vilket gör det svårt för IDE:s för php att hitta fel och poängtera dessa.</p>
        <p> Php har andra mer positiva aspekter dock. Det är Open Source och utvecklas av en bred community, (vilket kan vara en
            ...
            långt inom php i kursen än, men jag ser fram emot att lära mig mer.</p>
        ...
        <p> Ja jag fick lite hjälp angående syntaxen. Men programmeringstekniken var inte något nytt direkt.
            Det mesta var standardstruktuerer inom programmering som hanterade flow-control etc.</p>

        <h4>Övrigt</h4>
        <p> Momentet flöt på utan några större problem. Jag höll det enkelt och försökte inte krångla till lösningarna med egna
            funktioner och egen optimering. Nu kan jag lättare på egen hand utforska funktionaliteten i phps stora bibliotek.</p>
        <p>För inloggning så är username och password: bex</p>
        ...
        <p> Momentet rullade på ganska fort då jag känner mig hyffsat bekväm med CSS. Det var intressant att få mer information
            av hur sessioner kan användas för att dynamiskt ändra sidan. Jag stötte inte på några problem alls denna gång.</p>
        ...
        <p> Jag kan väll inte påstå att jag fullt ut bemästrar CSS, men jag får mindre och mindre problem stylingen. Dvs
            ...
            brukar arbetssättet se ut mer eller mindre oavsett erfarenhet antar jag.</p>
        ...
        <p> Jag tycker CSS är mycket vasst när det gäller stor effekt av små ändringar. Det krävs liksom oftast väldigt lite för
            ...
            ändringar då man vill testa något nytt.</p>
        ...
        <p> Jag la inte så mycket tid på att ändra den processbaserade lösning som mos skapat. Den kändes vettig och jag följde
            med i koden utan några problem. Jag hade något liknande i skallen då jag problemet introducerades.</p>
        ...
        <p> Eftersom jag redan byggt upp en egen ganska omfattande stylesheet redan så var jag mest sugen på att leka lite med
            färgsättningen. Min flickvän var självklart i rummet då så det blev såklart en rosa variant..... :P</p>

        <h4>Hur går det med ditt PHP:ande?</h4>
        <p> Det går bara fint, programmering är inte nåt nytt för mig. Jag gillar dock inte syntaxen, men det är väll en vanesak.</p>

        <hr>
        <h3>Redovisning av kmom05</h3>

        <h4>Reflektera över svårigheter/problem/lösningar/resultatet, etc.</h4>
        <p> Det gick stabilt denna gången med. Självklart blev det lite små buggar när man introducerade nya element som krävde ändringar i andra filer som
            man såklart direkt glömde bort. Men det löste sig ganska snabbt vid testning. Php kodandet kändes stabilt och tillsammans med Mos lösningar så lyckades jag ganska
            fort få ordning på "logiken". Jag skulle självklart kunna styla det hela lite bättre men jag valde att fokusera på php denna inlämning.</p>

        <h4>Hur känns det med PHP-programmeringen, har du kommit in i det? Är det svårt?</h4>
        <p> Det rullade på fint denna gången och jag känner att php växer för mig. Det blir roligare och roligare att gräva sig ner i språket
            trots att jag inte gillade syntaxen i början. Hittils så känns det som ett väldigt enkelt språk igentligen då vi inte skrivit någon
            svårare logik. Men det är kanske så språket oftast används. Det blir spännande att se hur databashanteringen ser ut i php, vilket
            enligt min kännedom är en tillämpning där php glänser.</p>

        <h4>Vilka är dina tips till en ovan PHP-programmerare?</h4>
        <p> Det beror på förkunskaperna. Om personen i fråga kan programmera sen innan så föreslår jag bara att man försöker ha överséende med syntaxen
            och använder vettiga variabelnamn där typen och syftet av variabler framgår tydligt. Detta på grund av den svaga typsäkerheten. En helt ny
            programmerare bör först och främst skaffa sig lite lärdom om hur datastrukturerna ser ut och processorinstruktionerna går till. Annars kan det
            lätt bli så att man har svårt att reflektera över varför programmet exekverar som det gör i vissa fall.</p>

        <h4>Har du nytta av guiden php20?</h4>
        <p> Jag kollade igenom den för någon inläming sedan. Men jag hade redan bra koll på innehållet så jag har ej kikat mer på guiden.</p>
